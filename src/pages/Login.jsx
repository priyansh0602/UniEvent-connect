...
import { GraduationCap, Users, Settings, ArrowLeft, Eye, EyeOff, CheckCircle, X } from 'lucide-react';
    ...
    <div className="min-h-screen bg-zinc-950 font-sans text-white">
      ...
      <div className="max-w-4xl mx-auto px-6 py-24 text-center relative">
        ...
        <div className="grid md:grid-cols-2 gap-10 relative z-10">
          <div
            className="card-student flex flex-col items-center text-center p-12 group"
          ...
          >
            ...
            <h3 className="text-3xl font-black mb-4">Student Login</h3>
            <p className="text-zinc-400 text-lg mb-8">Access events, register, and track your participation.</p>
            <button className="btn-secondary w-full">Access Portal</button>
          </div>

          <div
            className="card-admin flex flex-col items-center text-center p-12 group"
          ...
          >
            ...
            <h3 className="text-3xl font-black mb-4 text-white relative z-10">Admin Login</h3>
            <p className="text-zinc-400 text-lg mb-8 relative z-10">Manage events, view analytics, and oversee campus activities.</p>
